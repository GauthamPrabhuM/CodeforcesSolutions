...
{ 
    ...
    void solve()
    {
        ...
        //all elements divisible by d are painted red others blue beautiful if no pairs of adj elements with same color
        //task find d which yields beautiful colors
       ll n;
       cin>>n;
       cout<<n<<" ";
       for(ll i=1; i<n; i++)
