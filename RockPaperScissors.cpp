...
void solve() 
{
    ...
    game.insert(pair<string, string>("rock", "scissors"));
    game.insert(pair<string, string>("scissors", "paper"));
    game.insert(pair<string, string>("paper", "rock"));
    cin >> a >> b >> c;
    if (game[a] == b && game[a] == c)
    
        cout << "F";
    
    else if (game[b] == a && game[b] == c)
    
        cout << "M";
    
    else if (game[c] == a && game[c] == b)
